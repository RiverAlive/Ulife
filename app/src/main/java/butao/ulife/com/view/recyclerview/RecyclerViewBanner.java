...
public class RecyclerViewBanner extends FrameLayout {
    ...
    public RecyclerViewBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (sd == null) {
            mSelectedDrawable = getResources().getDrawable(R.drawable.banner_point_selected);
...
//            mUnselectedDrawable = generateDefaultDrawable(DEFAULT_UNSELECTED_COLOR);
            mUnselectedDrawable = getResources().getDrawable(R.drawable.banner_point_unselected);
        } else {
