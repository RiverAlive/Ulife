...
import butao.ulife.com.jpush.adapter.AlbumListAdapter;
import butao.ulife.com.jpush.entity.ImageBean;
import butao.ulife.com.jpush.tools.SortPictureList;

/*
 * 本地图片集界面
 */
public class PickPictureTotalActivity extends BaseIMActivity {
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, CApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == CApplication.RESULT_CODE_SELECT_ALBUM) {
			setResult(CApplication.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
