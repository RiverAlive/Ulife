...
import butao.ulife.com.jpush.activity.BrowserViewPagerActivity;
...
import butao.ulife.com.jpush.entity.FileType;
...
//            }
        ...
        if (holder.picture != null) {
            ...
            holder.picture.setTag(R.id.jmui_picture_iv,position);
            ...
            switch (msg.getContentType()) {
                ...
                case image:
                    if (holder.picture != null && v.getId() == holder.picture.getId()) {
                        ...
                        intent.putExtra(CApplication.TARGET_ID, mConv.getTargetId());
                        intent.putExtra("msgId", msg.getId());
                        if (mConv.getType() == ConversationType.group) {
                            GroupInfo groupInfo = (GroupInfo) mConv.getTargetInfo();
                            intent.putExtra(CApplication.GROUP_ID, groupInfo.getGroupID());
                        }
                        intent.putExtra(CApplication.TARGET_APP_KEY, mConv.getTargetAppKey());
                        intent.putExtra("msgCount", mMsgList.size());
                        intent.putIntegerArrayListExtra(CApplication.MsgIDs, getImgMsgIDList());
                ...
                case file:
                    ...
                    if (!TextUtils.isEmpty(content.getLocalPath())) {
                        ...
                        if (msg.getDirect() == MessageDirect.send) {
                            ...
                            final String newPath = CApplication.FILE_DIR + fileName;
